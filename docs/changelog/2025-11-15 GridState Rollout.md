...
- Simulation logic now lives under dedicated modules (`core/environment/cell.py`, `core/model/state.py`, `core/rules.py`, `core/environment/spatial.py`, `core/grid/viz.py`) and the aggregate-only `core/simulation.py` was removed.
